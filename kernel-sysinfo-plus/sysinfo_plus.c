...
/* Some kernel trees may not expose si_meminfo prototype via included headers. */
#ifndef HAVE_DECL_SI_MEMINFO
...
/* Use proc_ops for modern kernels (5.6+). Older kernels are out of scope for this module. */
